...
trait Billable
{
    ...
    {
        return (new PaymentGateway($this))->charge($amount, $options);
    }
    ...
    {
        return new PaymentGateway($this, $plan);
    }
    ...
    public function findInvoice($id)
    {
        ...
        if ($invoice && $invoice->customer == $this->getPaymentId()) {
            return $invoice;
        }
    }
    ...
    public function subscribed()
    {
        if ($this->requiresCardUpFront()) {
            return $this->gatewayIsActive() || $this->onGracePeriod();
        } else {
            return $this->gatewayIsActive() || $this->onTrial() || $this->onGracePeriod();
        }
    }
    ...
    {
        return $this->readyForBilling() && ! $this->gatewayIsActive();
    }
    ...
    {
        return $this->gatewayIsActive() && $this->subscription()->planId() == $plan;
    }
    ...
    {
        return ! is_null($this->getPaymentId());
    }
    ...
    {
        $this->setGatewayIsActive(false);

        $this->gateway_subscription = null;
    ...
    {
        return ! is_null($this->gateway_id);
    }
     ...
     * @return string
     */
    public function getGatewayIdName()
    {
        return 'gateway_id';
    }
    ...
    {
        return $this->gateway_subscription;
    }
    ...
    {
        $this->gateway_subscription = $subscription_id;
     ...
     * @return \Laravel\Cashier\Contracts\Billable
     */
    public function setGatewayPlan($plan)
    {
        $this->gateway_plan = $plan;
    ...
    {
        return static::$apiKey ?: Config::get('services.cashier.secret');
    }
