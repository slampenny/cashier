...
class LineItem
{
     ...
     * @var object
     */
    protected $gatewayLine;

    /**
     * Create a new line item instance.
     *
     * @param  Billable  $billable
     * @param  object  $gatewayLine
     * @return void
     */
    public function __construct(BillableContract $billable, $gatewayLine)
    {
        $this->billable = $billable;
        $this->gatewayLine = $gatewayLine;
    }
     ...
     * @return object
     */
    public function getGatewayLine()
    {
        return $this->gatewayLine;
    }
