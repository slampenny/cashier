...
class Invoice
{
    ...
    {
        return $this->subtotal > 0 && $this->subtotal != $this->total && ! is_null($this->gatewayInvoice->discount);
    }
    ...
    {
        if (isset($this->gatewayInvoice->discount)) {
    ...
    {
        return $this->gatewayInvoice->{$key};
    }
