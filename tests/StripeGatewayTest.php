...
use Mockery as m;
use Laravel\Cashier\PaymentGateway;
...
class StripeGatewayTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testUpdateQuantity()
    {
        ...
        $gateway = new PaymentGateway($this->mockBillableInterface(), 'plan');
    ...
    {
        $billable = $this->mockBillableInterface();
        $gateway = new PaymentGateway($billable, 'plan');
        ...
        $gateway->updateLocalGatewayData($customer);
    }
